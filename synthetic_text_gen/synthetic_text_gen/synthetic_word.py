            ...
            with open(os.path.join(font_dir,csv_file)) as f:
                ...
                if clear:
                    ...
                    for i in range(len(self.fonts)):
                        self.fonts[i] = (self.fonts[i][0].split('/')[-1], self.fonts[i][1], self.fonts[i][2], self.fonts[i][3])
                    for i in range(len(self.bracket_fonts)):
                        self.bracket_fonts[i] = (self.bracket_fonts[i][0].split('/')[-1], self.bracket_fonts[i][1], self.bracket_fonts[i][2], self.bracket_fonts[i][3])
                else:
