...
'''Creates gpt2_form_generation.json with questions/answers pairs for GPT-2
'''
...
if not os.path.exists(os.path.join(cache_path,'dataset_info.json')):
    wikipedia = load_dataset('wikipedia', '20220301.simple', cache_dir=cache_path)['train']
...
with open('data/gpt2_form_generation.json', 'w') as out:
